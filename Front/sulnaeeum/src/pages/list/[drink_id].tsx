    ...
    <>
      <div className={'bg-[url("/images/pattern1.png")] bg-no-repeat bg-[left_-17rem_bottom_80rem] h-[2500px]'}>
        <div className={'flex pt-[100px] justify-center'}>
          ...
          <FaBookmark onClick={()=>like()} className={'text-[22px] text-[#655443] cursor-pointer mt-5 ml-4'} />:
          <FaRegBookmark onClick={()=>like()} className={'text-[22px] text-[#655443] cursor-pointer mt-5 ml-4'}/>}
        </div>
