...
const info : MbtiType = {
    ...
    enfj : {drinkId: 636, dish: '치즈', summary: '과일과 꽃 향기가 느껴지는 우아한 감 와인', drink: '뱅꼬레 더감', good: 'isfp', bad: 'isfj', color: '#FFECD7'},
    ...
    isfp : {drinkId: 635, dish: '갈비찜', summary: '담황색으로 풀어내는 진한 풀향과 과실향', drink: '호산춘', good: 'esfj', bad: 'enfp', color: '#D1F8C7'},
    esfp : {drinkId: 542, dish: '회', summary: '누구에게나 부담없이, 상큼한 맛을 자랑하는', drink: '키위술', good: 'istj', bad: 'infp', color: '#EAEAEA'},
    istp : {drinkId: 633, dish: '피자', summary: '한 모금에 진하게 퍼지는 오미자향', drink: '볼빨간 미자', good: 'estj', bad: 'infp', color: '#E7BFA8'},
    ...
    istj : {drinkId: 634, dish: '연어', summary: '화려한 히비스커스와 새콤달콤 화자오까지', drink: '단홍', good: 'esfp', bad: 'infj', color: '#DAB4B8'},
