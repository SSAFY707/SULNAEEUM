  ...
  return (
    <>
      <div className="flex flex-col items-center w-screen h-auto">
        <div className={'flex justify-between w-7/12 mt-28 h-[90px]'}>
          <div className={'ml-8'}>
            <div className={'text-[32px] font-preB'}>전통주 랭킹</div>
        ...
        <div className={"flex flex-col items-center w-7/12 h-auto mb-20 bg-zinc-100"}>
            {/* <div className={"flex justify-end w-full"}>인기있는 술</div> */}
            <div className={"w-full px-10 pt-14 flex justify-center"}>
              <div className={"flex w-[350px] h-[360px] rounded mx-4 bg-white"}>
                <div className={"flex flex-col items-center w-full"}>
                  <div className={"flex w-full"}>
                    <img className={"ml-4 mt-4 w-[44px] h-[44px]"} src="/images/rank/1.png" />
                  </div>
                  <img className={"h-[150px] relative top-[-20px]"} src="/images/jubti/drink/단홍.png" alt="" />
            ...
            <div className={"flex flex-col w-full items-center mt-10 mb-10 px-16"}>
              <div className={"flex items-center px-10 w-full h-[100px] rounded my-2 bg-white"}>
                <div className={"text-[30px] font-preB text-zinc-400 mr-10"}>4</div>
