    ...
    <>
      ...
      <div className="h-[7000px] overflow-hidden scroll-smooth">
        ...
        <div className="absolute top-[85px] left-[590px] w-[800px] h-[170px]  ">
            <div className="absolute left-[180px] text-[50px] font-preB text-[#393939]">개인의 취향에 맞는</div>
            <div className="absolute left-[90px] top-[60px] text-[50px] font-preB text-[#977857]">나만의 전통주</div>
            <div className="absolute left-[360px] top-[60px] text-[50px] font-preB text-[#393939]">를 추천합니다.</div>
        ...
        <div className="absolute  top-[4500px] w-screen h-[1000px]  flex">
          <div className="absolute top-[100px] w-[600px] h-[620px] left-[320px]  ">
            ...
            <Image className="absolute top-[350px] left-[390px]" src="/main/part4/main4_4s.png" alt="" width={180} height={300 }></Image>
