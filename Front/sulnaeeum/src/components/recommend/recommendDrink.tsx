    ...
    return(
        <>
            ...
            <div className={'flex flex-col items-center absolute top-[370px] w-[500px] h-[240px] rounded-lg'}>
              ...
              <div onClick={()=>(router.push('/user/prefer'))} className={'h-[70px] w-[60%] flex justify-center items-center bg-gradient-to-r from-indigo-900 to-blue-800 hover:-translate-y-1 duration-[300ms] ease-in text-white text-[20px] drop-shadow-md cursor-pointer rounded-full'}>나만의 전통주 추천받기</div>
            </div>
            }
        </>
    )
