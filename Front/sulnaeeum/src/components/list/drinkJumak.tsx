  ...
  return (
    <div className={'w-7/12 h-[700px] mt-[200px]'}>
        ...
        <div className={'flex justify-between items-end'}>
            ...
            <div onClick={modalOpen} className={'flex justify-center items-center mb-3 mr-3 rounded text-white h-3/4 p-2 bg-gradient-to-r from-[#051525] to-teal-800 transition ease-in duration-300 hover:font-preR hover:scale-[103%] hover:-translate-y-0.5 cursor-pointer'}>판매처 등록하기</div>
        </div>
