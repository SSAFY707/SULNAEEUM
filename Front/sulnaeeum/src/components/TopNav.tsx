...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="styles.nav h-[50px] flex items-center text-[15px] preBL border-b-2 hover:bg-sky-300 hover:">
        ...
        <div
          ...
          className="pt-[10px] basis-1/2 flex justify-between items-center hover:h-[520px] hover:bg-sky-300"
        >
          <Link href="/list">
            <div className=" hover:bg-sky-500 flex justify-center hover_box w-[130px] h-[60px] flex items-center hover:h-[470px]">
